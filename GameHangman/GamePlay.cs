...
namespace GameHangman
{
    ...
    public class GamePlay : Activity
    {
        ...
        String[] word = { "money", "Honey", "Kites", "Games", "Task", "Great", "Views", "Know","Sami","Sony" };
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Game_design);
        ...
        private void chk(Char x)
        {
            ...
            {
                Toast.MakeText(Application.Context, "You won the Game", ToastLength.Short).Show();
            }
